...
func getSessionIntegrations() *model.SessionIntegrations {
	return &model.SessionIntegrations{
		Integrations: getAllIntegrations(),
		Builtins:     getBuiltinIntegrations(),
	}
}

func getAllIntegrations() []*model.SessionIntegration {
	return []*model.SessionIntegration{
...
func getBuiltinIntegrations() []*model.SessionIntegration {
	return []*model.SessionIntegration{
		&model.SessionIntegration{
			Name:        "Webhook",
